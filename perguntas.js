export const perguntas = [
    {
        enunciado: "Como a inteligência artificial pode ser utilizada para personalizar o ensino e atender às necessidades individuais dos alunos?",
        alternativas: [
            {
                texto: "O uso excessivo da inteligência artificial pode resultar na diminuição da interação humana significativa, afetando o desenvolvimento das habilidades sociais e emocionais dos alunos.",
                afirmacao: [
                    "A interação humana é essencial para o desenvolvimento dos alunos, complementando o papel da inteligência artificial na personalização do ensino."
                ],
                proxima: 1,
            },
            {
                texto: "A inteligência artificial pode ser uma ferramenta eficaz na personalização do ensino, possibilitando um a abordagem mais adaptativa e engajadora.",
                afirmacao: [
                    "A inteligência artificial pode melhorar a eficácia e enganjamento dos alunos ao adaptar o ensino às suas necessidades individuais."
                ],
                proxima: 2,
            },
        ]
